...
data class TransformResult(val center: Float3, val scaleFactor: Float)
class AppModelViewer(
    val engine: Engine,
    ...
    private lateinit var gestureDetector: AppGestureDetector
    ...
    constructor(
        ...
        gestureDetector = AppGestureDetector(surfaceView, cameraManipulator)
    ...
    constructor(
        ...
        gestureDetector = AppGestureDetector(textureView, cameraManipulator)
...
//    }
    ...
    fun transformToUnitCube(centerPoint: Float3 = kDefaultObjectPosition): TransformResult? {
        asset?.let { asset ->
            val tm = engine.transformManager
            var center = asset.boundingBox.center.let { v -> Float3(v[0], v[1], v[2]) }
            val halfExtent = asset.boundingBox.halfExtent.let { v -> Float3(v[0], v[1], v[2]) }
            ...
            val transform = scale(Float3(scaleFactor)) * translation(-center)
            tm.setTransform(tm.getInstance(asset.root), transpose(transform).toFloatArray())
            Log.d("Test x",transform.toString() )

            // Return the center and scale factor
            return TransformResult(center, scaleFactor)
        }
        return null
    }
    ...
    private fun addDetachListener(view: android.view.View) {
        view.addOnAttachStateChangeListener(object : android.view.View.OnAttachStateChangeListener {
            ...
            override fun onViewDetachedFromWindow(v: android.view.View) {
                ...
                engine.destroyView(this@AppModelViewer.view)
